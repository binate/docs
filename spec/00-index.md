...
| 10 | [Functions, Methods, and Function Values](10-functions-methods-function-values.md) | mixed | Stable (functions/methods); variadics + spread §10.3 Draft (specified, not yet implemented) | `func` |
