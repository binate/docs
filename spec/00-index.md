...
| 14.8 | [Control-flow statements](14b-control-flow.md) | mixed | language rules Stable; a few open semantic items; type-switch stmt §14.10 implemented (§11.12); defer §14.13 Draft (ratified, not yet implemented) | `stmt` |
